...
const name = "Sami Elsayed";
export const siteTitle = "Elsayed's Research Website";
    ...
    return (
        <div className={ styles.container }>
            <Head>
                ...
                <meta name="description" content="The official website for Sami Elsayed's research" />
